...
import 'package:myflutter/demos/login2/anim_lib/shake_animation_builder.dart';
...
class _ShakeAnimationState extends State<ShakeAnimationWidget> with SingleTickerProviderStateMixin {
  ///动画控制器
  ...
  void initState() {
    ...
    _angleAnimation = TweenSequence<double>([
      ...
      TweenSequenceItem<double>(tween: Tween(begin: 0, end: _shakeRange), weight: 1),
      TweenSequenceItem<double>(tween: Tween(begin: _shakeRange, end: 0), weight: 2),
      TweenSequenceItem<double>(tween: Tween(begin: 0, end: -_shakeRange), weight: 3),
      TweenSequenceItem<double>(tween: Tween(begin: -_shakeRange, end: 0), weight: 4),
